...
#else
    // Kos Rabak
    archivePath				=	optionsGetSearchPath("%PIXIEHOME%/ribs" ,NULL);
    proceduralPath			=	optionsGetSearchPath("%PIXIEHOME%/procedurals" ,NULL);
    texturePath				=	optionsGetSearchPath("%PIXIEHOME%/textures" ,NULL);
    shaderPath				=	optionsGetSearchPath("%PIXIEHOME%/shaders" ,NULL);
    displayPath				=	optionsGetSearchPath("%PIXIEHOME%/displays" ,NULL);
    modulePath				=	optionsGetSearchPath("%PIXIEHOME%/modules" ,NULL);
